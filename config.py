...
# Default Public Client ID (Azure CLI public app) or custom Azure App Registration Client ID
...
DEFAULT_FROM_NAME = os.getenv("DEFAULT_FROM_NAME", "Automation Dispatcher")
